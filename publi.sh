...
if [ "$TRAVIS" == true ]; then
  ...
  [ -n "$encrypted_c21317fa31a7_key" -a -n "$encrypted_c21317fa31a7_iv" ] || (echo "Travis CI decryption keys not found"; exit 1)
  openssl aes-256-cbc -K "$encrypted_c21317fa31a7_key" -iv "$encrypted_c21317fa31a7_iv" -in github-deploy-key.enc -out github-deploy-key -d
